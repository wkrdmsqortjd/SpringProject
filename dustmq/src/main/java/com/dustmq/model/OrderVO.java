...
// 배송정보 , 사용 포인트 정보 , 여러가지의 주문 상품 정보를 담는 클래스
public class OrderVO {
	...
	/* 주문 상품 */
	private List<OrderItemVO> orders;	// 구매하는 상품이 여러 개 일 경우
	...
	public String toString() {
		return "OrderVO [orderId=" + orderId + ", customer=" + customer + ", memberId=" + memberId + ", memberAddr1="
	...
	public void getOrderPriceInfo() {
		...
		if(orderSalePrice >= 30000) {
				deliveryCost = 0;		// 총 결제액이 30000원 이상이면 배송비 0원
		} else {
				deliveryCost = 3000;	// 총 결제액이 30000원 이하이면 배송비 3000원
		}
