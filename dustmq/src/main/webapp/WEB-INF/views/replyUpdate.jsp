...
$(document).ready(function(){
	...
	/* Controller로부터 전달받은 데이터를 저장 */
	let rating = '${replyInfo.rating}';

	/* option태그가 여러개라 객체에 접근하면 배열형태. */
	$("option").each(function(i,obj){	/* each()를 통해 모든 요소에 순차적으로 접근 가능 */

		if(rating == $(obj).val()){	/* rating의 값이 해당 객체의 값과 같으면 */
			$(obj).attr("selected", "selected");	/* selected 속성 추가 */
		}
	...
	$(".update_btn").on("click", function(e){
		...
		// 서버로 전송할 데이터들, 수정 버튼을 누르면 각 변수에 대입
