	...
	<%@include file="../includes/admin/header.jsp" %>
                ...
                <div class="admin_content_wrap">
                    ...
                    <div class="admin_content_main">
						...
						<!-- 작가 정보 수정을 처리하는 메서드에 데이터 전달하는 form -->                    
...
<script>
	...
	$("#modifyBtn").on("click", function(e){
		...
		if(!authorName) {
			$("#warn_authorName").css("display", "block");	// 아이디 입력 시 경고문 x
		} else {
			$("#warn_authorName").css("display", "none");	// 아이디 공란 시 경고문 o
			nameCk = true;
		}
		
		if(!authorIntro) {
			$("#warn_authorIntro").css("display", "block");	// 소개란 입력 시 경고문 x
		} else {
			$("#warn_authorIntro").css("display", "none");	// 소개란 공란 시 경고문 o
			introCk = true;
		}
		
	 	 if(nameCk && introCk) {
				modifyForm.submit();	// 아이디와 소개란을 입력하면 전송
		} else {
				return false; 		// 안하면 작동 안됨
		}  
